...
class Play implements Variables {
     ...
     *
     * @param input file to read packagenames from
     */
     ...
     *
     * @param input file containing a list of packagenames.
     */
     ...
     * Download an app.
     *
     * @param doc packagename
     * @param vc  versioncode (maybe -1 to get the latest one).
     * @param ot  should always be 1.
     */
    ...
    public static void refreshProfile() throws Exception {
        PlayProfile pp = getProfile();
